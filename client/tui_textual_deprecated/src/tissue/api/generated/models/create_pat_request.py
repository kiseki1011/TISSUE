...
class CreatePatRequest(BaseModel):
    ...
    CreatePatRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=50)] = Field(description="Label for this token")
    scope: StrictStr = Field(description="Permission scope of the token")
    ttl_days: Optional[Annotated[int, Field(le=365, strict=True)]] = Field(default=None, description="Days until expiry (omit for no expiry)", alias="ttlDays")
    __properties: ClassVar[List[str]] = ["name", "scope", "ttlDays"]
