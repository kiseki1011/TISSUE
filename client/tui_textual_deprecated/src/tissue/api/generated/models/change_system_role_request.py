...
class ChangeSystemRoleRequest(BaseModel):
    """
    ChangeSystemRoleRequest
    """ # noqa: E501
    role: StrictStr = Field(description="New system role to assign")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChangeSystemRoleRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChangeSystemRoleRequest from a dict"""
        if obj is None:
            return None
