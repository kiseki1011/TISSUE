...
class GuardConfigData(BaseModel):
    """
    GuardConfigData
    """ # noqa: E501
    guard_type: StrictStr = Field(alias="guardType")
    order: StrictInt
    params: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["guardType", "order", "params"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuardConfigData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuardConfigData from a dict"""
        if obj is None:
            return None
