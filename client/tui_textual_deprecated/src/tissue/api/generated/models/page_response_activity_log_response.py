...
class PageResponseActivityLogResponse(BaseModel):
    """
    Offset-based paginated response.
    """ # noqa: E501
    content: Optional[List[ActivityLogResponse]] = Field(default=None, description="Items in this page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageResponseActivityLogResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageResponseActivityLogResponse from a dict"""
        if obj is None:
            return None
