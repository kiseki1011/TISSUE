...
class AttachWikiTagRequest(BaseModel):
    """
    AttachWikiTagRequest
    """ # noqa: E501
    color: Optional[StrictStr] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=18)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttachWikiTagRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttachWikiTagRequest from a dict"""
        if obj is None:
            return None
