...
class CursorPageNotificationResponse(BaseModel):
    """
    Cursor-based paginated response with an opaque next-page token.
    """ # noqa: E501
    content: Optional[List[NotificationResponse]] = Field(default=None, description="List of items in this page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CursorPageNotificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CursorPageNotificationResponse from a dict"""
        if obj is None:
            return None
