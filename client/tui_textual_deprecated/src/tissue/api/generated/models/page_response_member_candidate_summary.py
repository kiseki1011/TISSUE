...
class PageResponseMemberCandidateSummary(BaseModel):
    """
    Offset-based paginated response.
    """ # noqa: E501
    content: Optional[List[MemberCandidateSummary]] = Field(default=None, description="Items in this page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageResponseMemberCandidateSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageResponseMemberCandidateSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "content": [MemberCandidateSummary.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
