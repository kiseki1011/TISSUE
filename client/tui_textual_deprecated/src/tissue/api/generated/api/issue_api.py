...
class IssueApi:
    ...
    async def list_project_trash(
        self,
        project_key: StrictStr,
        mine_only: Optional[StrictBool] = None,
        ...
        """List a project's deleted issues

        List the project's soft-deleted issues (the trash), newest deletion first, so they can be reviewed and restored.  - `mineOnly=true` limits the list to issues you authored. Otherwise every deleted issue in the project is returned. - `page` is the zero-based page index (default 0) - `size` is the page size (default 20, max 100)  **Requirements:** - Requires project membership
        ...
        _param = self._list_project_trash_serialize(
            project_key=project_key,
            mine_only=mine_only,
            page=page,
            size=size,
    ...
    @validate_call
    async def list_project_trash_with_http_info(
        self,
        project_key: StrictStr,
        mine_only: Optional[StrictBool] = None,
        page: Optional[StrictInt] = None,
    ...
    @validate_call
    async def list_project_trash_without_preload_content(
        self,
        project_key: StrictStr,
        mine_only: Optional[StrictBool] = None,
        page: Optional[StrictInt] = None,
    ...
    def _list_project_trash_serialize(
        self,
        project_key,
        mine_only,
        page,
        ...
        if project_key is not None:
            _path_params['projectKey'] = project_key
        # process the query parameters
        if mine_only is not None:
            
            _query_params.append(('mineOnly', mine_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/projects/{projectKey}/issues:trash',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
