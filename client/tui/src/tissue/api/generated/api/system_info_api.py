...
class SystemInfoApi:
    ...
    async def get_system_info(
        ...
        Retrieve the server's public configuration including signup settings and available auth providers.
    ...
    def _get_system_info_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/system-info',
