...
class InvitationApi:
    ...
    def _accept_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/invitations/{invitationId}:accept',
    ...
    async def list_my_invitations(
        ...
        _param = self._list_my_invitations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def list_my_invitations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def list_my_invitations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_my_invitations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/invitations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def reject_invitation_with_http_info(
        self,
        invitation_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def reject_invitation_without_preload_content(
        self,
        invitation_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _reject_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/invitations/{invitationId}:reject',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
