...
class SuperAdminAuditApi:
    ...
    async def admin_list_audit_logs(
        ...
        _param = self._admin_list_audit_logs_serialize(
            pageable=pageable,
    ...
    @validate_call
    async def admin_list_audit_logs_with_http_info(
        self,
        pageable: Pageable,
        actor_member_id: Optional[StrictInt] = None,
        action: Optional[StrictStr] = None,
    ...
    @validate_call
    async def admin_list_audit_logs_without_preload_content(
        self,
        pageable: Pageable,
        actor_member_id: Optional[StrictInt] = None,
        action: Optional[StrictStr] = None,
    ...
    def _admin_list_audit_logs_serialize(
        self,
        pageable,
        actor_member_id,
        action,
