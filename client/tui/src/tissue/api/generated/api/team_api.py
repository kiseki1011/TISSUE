...
class TeamApi:
    ...
    async def create_team(
        ...
        Create a new global team. (ex: \"Infra\", \"DevOps\")  **Requirements:** - Requires system `ADMIN` or higher role
    ...
    async def delete_team(
        ...
        Permanently delete a global team. Any member currently belonging to it is unassigned.  **Requirements:** - Requires system `ADMIN` or higher role
    ...
    def _delete_team_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/teams/{teamId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_teams(
        ...
        List all global teams.  **Requirements:** - Requires authentication
    ...
    async def update_team(
        ...
        Update a team's name, description, or color. Only provided fields are updated.  **Requirements:** - Requires system `ADMIN` or higher role
