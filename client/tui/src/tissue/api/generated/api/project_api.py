...
class ProjectApi:
    ...
    @validate_call
    async def check_project_key_availability(
        self,
        project_key: StrictStr,
        _request_timeout: Union[
            None,
        ...
        Check whether a project key can be used. It must not be a reserved prefix and must be globally unique. Use for validation before creating a project.
        ...
        _param = self._check_project_key_availability_serialize(
            project_key=project_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def check_project_key_availability_with_http_info(
        self,
        project_key: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def check_project_key_availability_without_preload_content(
        self,
        project_key: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _check_project_key_availability_serialize(
        self,
        project_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/projects/{projectKey}:check',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
