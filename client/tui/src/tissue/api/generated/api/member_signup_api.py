...
class MemberSignupApi:
    ...
    @validate_call
    async def signup_o_auth(
        self,
        signup_o_auth_member_request: SignupOAuthMemberRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Register a new member using an OAuth provider.  **Requirements:** - Requires a register token obtained from the OAuth callback - `username` must be unique

        :param signup_o_auth_member_request: (required)
        :type signup_o_auth_member_request: SignupOAuthMemberRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._signup_o_auth_serialize(
            signup_o_auth_member_request=signup_o_auth_member_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def signup_o_auth_with_http_info(
        self,
        signup_o_auth_member_request: SignupOAuthMemberRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthSignupResponse]:
        """Sign up with OAuth
    ...
    @validate_call
    async def signup_o_auth_without_preload_content(
        self,
        signup_o_auth_member_request: SignupOAuthMemberRequest,
        _request_timeout: Union[
            None,
    ...
    def _signup_o_auth_serialize(
        self,
        signup_o_auth_member_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if signup_o_auth_member_request is not None:
            _body_params = signup_o_auth_member_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/members/signup/oauth',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
