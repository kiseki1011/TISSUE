...
class WorkflowApi:
    ...
    async def check_workflow_state_name_availability(
        ...
        Check whether a state name is available within the workflow.  **Requirements:** - `name` must be unique within the workflow
    ...
    async def get_workflow(
        ...
        Retrieve the full detail of a workflow including states, transitions, and guards.
    ...
    async def list_workflows(
        ...
        Retrieve all workflows in the project.
