...
class SprintApi:
    ...
    async def get_sprint(
        ...
        Retrieve the full detail of a sprint.
    ...
    async def list_project_sprints(
        ...
        Page through sprints in a project. Optional `statuses` filter accepts a comma-separated set of sprint statuses (e.g. `statuses=ACTIVE,PLANNING`). Caller must be a member of the project.
    ...
    async def list_sprint_issue_keys(
        ...
        """Get sprint issue keys

        Retrieve all issue keys assigned to a sprint.
