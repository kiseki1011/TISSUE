...
class AuthenticationApi:
    ...
    async def login(
        ...
        Authenticate with identifier and password to obtain JWT tokens. The identifier is either `email` or `username` depending on the server's `email-required` setting.  **Requirements:** - **Unavailable in OIDC mode**
    ...
    @validate_call
    async def poll_oidc_device_login(
        self,
        device_poll_request: DevicePollRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._poll_oidc_device_login_serialize(
            device_poll_request=device_poll_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def poll_oidc_device_login_with_http_info(
        self,
        device_poll_request: DevicePollRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def poll_oidc_device_login_without_preload_content(
        self,
        device_poll_request: DevicePollRequest,
        _request_timeout: Union[
            None,
    ...
    def _poll_oidc_device_login_serialize(
        self,
        device_poll_request,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if device_poll_request is not None:
            _body_params = device_poll_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/auth/oidc/device:poll',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def start_oidc_device_login(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._start_oidc_device_login_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def start_oidc_device_login_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def start_oidc_device_login_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _start_oidc_device_login_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/auth/oidc/device:start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
