...
class AdvancedSystemInfoApi:
    ...
    async def admin_get_system_info(
        ...
        _param = self._admin_get_system_info_serialize(
    ...
    @validate_call
    async def admin_get_system_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def admin_get_system_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _admin_get_system_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/admin/system-info',
