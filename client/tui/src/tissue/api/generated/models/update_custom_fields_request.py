...
class UpdateCustomFieldsRequest(BaseModel):
    ...
    """ # noqa: E501
    custom_fields: Dict[str, Any] = Field(description="Map of custom field ID to its value. Value type must match the field's type (ex: string for TEXT, number for INTEGER).", alias="customFields")
