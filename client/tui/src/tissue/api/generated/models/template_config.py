...
class TemplateConfig(BaseModel):
    ...
    TemplateConfig
    """ # noqa: E501
    issue_types: Optional[List[TemplateIssueType]] = Field(default=None, alias="issueTypes")
    workflows: Optional[List[TemplateWorkflow]] = None
    __properties: ClassVar[List[str]] = ["issueTypes", "workflows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issueTypes": [TemplateIssueType.from_dict(_item) for _item in obj["issueTypes"]] if obj.get("issueTypes") is not None else None,
            "workflows": [TemplateWorkflow.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
        return _obj
