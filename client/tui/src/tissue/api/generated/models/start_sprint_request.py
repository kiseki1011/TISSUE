...
class StartSprintRequest(BaseModel):
    ...
    StartSprintRequest
    """ # noqa: E501
    due_at: datetime = Field(description="Due date of the sprint", alias="dueAt")
    __properties: ClassVar[List[str]] = ["dueAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartSprintRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartSprintRequest from a dict"""
        if obj is None:
            return None
