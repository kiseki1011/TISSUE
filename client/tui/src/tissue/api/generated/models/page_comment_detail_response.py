...
class PageCommentDetailResponse(BaseModel):
    """
    PageCommentDetailResponse
    """ # noqa: E501
    content: Optional[List[CommentDetailResponse]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageCommentDetailResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageCommentDetailResponse from a dict"""
        if obj is None:
            return None
