...
class WorkspaceMemberDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "email", "joinedAt", "memberId", "role", "username", "workspaceKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceMemberDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceMemberDetail from a dict"""
        if obj is None:
            return None
