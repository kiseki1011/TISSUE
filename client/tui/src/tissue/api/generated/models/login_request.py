...
class LoginRequest(BaseModel):
    ...
    LoginRequest
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=0, strict=True, max_length=255)] = Field(description="Email or username depending on server's `email-required` setting")
    password: Annotated[str, Field(min_length=0, strict=True, max_length=100)]
