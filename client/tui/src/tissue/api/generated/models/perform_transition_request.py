...
class PerformTransitionRequest(BaseModel):
    ...
    """ # noqa: E501
    transition_id: StrictInt = Field(description="ID of the workflow transition to execute", alias="transitionId")
    __properties: ClassVar[List[str]] = ["transitionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PerformTransitionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PerformTransitionRequest from a dict"""
        if obj is None:
            return None
