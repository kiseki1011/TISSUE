...
class ProjectTemplateDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["config", "createdAt", "description", "id", "name", "workspaceKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectTemplateDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectTemplateDetail from a dict"""
        if obj is None:
            return None
