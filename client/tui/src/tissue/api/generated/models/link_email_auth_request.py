...
class LinkEmailAuthRequest(BaseModel):
    """
    LinkEmailAuthRequest
    """ # noqa: E501
    password: Annotated[str, Field(min_length=8, strict=True, max_length=30)] = Field(description="Password for the new email authentication")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkEmailAuthRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkEmailAuthRequest from a dict"""
        if obj is None:
            return None
