...
class PageProjectTemplateSummary(BaseModel):
    """
    PageProjectTemplateSummary
    """ # noqa: E501
    content: Optional[List[ProjectTemplateSummary]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageProjectTemplateSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageProjectTemplateSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "content": [ProjectTemplateSummary.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "empty": obj.get("empty"),
            "first": obj.get("first"),
            "last": obj.get("last"),
