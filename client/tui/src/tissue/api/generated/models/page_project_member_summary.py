...
class PageProjectMemberSummary(BaseModel):
    """
    PageProjectMemberSummary
    """ # noqa: E501
    content: Optional[List[ProjectMemberSummary]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageProjectMemberSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageProjectMemberSummary from a dict"""
        if obj is None:
            return None
