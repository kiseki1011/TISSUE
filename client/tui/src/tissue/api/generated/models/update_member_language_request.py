...
class UpdateMemberLanguageRequest(BaseModel):
    """
    ...
    def language_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['KO', 'EN']):
            raise ValueError("must be one of enum values ('KO', 'EN')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateMemberLanguageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateMemberLanguageRequest from a dict"""
        if obj is None:
            return None
