...
class PageIssueSummary(BaseModel):
    """
    PageIssueSummary
    """ # noqa: E501
    content: Optional[List[IssueSummary]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageIssueSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageIssueSummary from a dict"""
        if obj is None:
            return None
