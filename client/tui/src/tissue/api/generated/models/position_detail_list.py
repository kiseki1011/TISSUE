...
class PositionDetailList(BaseModel):
    """
    PositionDetailList
    """ # noqa: E501
    positions: Optional[List[PositionDetail]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionDetailList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionDetailList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "positions": [PositionDetail.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
