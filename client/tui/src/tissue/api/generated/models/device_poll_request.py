...
class DevicePollRequest(BaseModel):
    """
    Poll an OIDC device login that is in progress
    """ # noqa: E501
    device_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The device code returned by device:start", alias="deviceCode")
    __properties: ClassVar[List[str]] = ["deviceCode"]
