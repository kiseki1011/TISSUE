...
class TemplateIssueField(BaseModel):
    """
    TemplateIssueField
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "name", "options", "position", "required", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateIssueField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateIssueField from a dict"""
        if obj is None:
            return None
