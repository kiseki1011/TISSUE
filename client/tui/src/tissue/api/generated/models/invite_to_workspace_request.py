...
class InviteToWorkspaceRequest(BaseModel):
    """
    Invite members to a workspace by email. Optionally specify project keys to automatically add invited members to specific projects.
    """ # noqa: E501
    emails: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=50)]
    role: StrictStr
    target_project_keys: Optional[List[StrictStr]] = Field(default=None, alias="targetProjectKeys")
    __properties: ClassVar[List[str]] = ["emails", "role", "targetProjectKeys"]
