...
class IssueTypeSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["color", "description", "hierarchy", "icon", "id", "name", "systemProvided", "workflowId", "workflowName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueTypeSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueTypeSummary from a dict"""
        if obj is None:
            return None
