...
class PatResponse(BaseModel):
    """
    Personal Access Token (PAT) metadata
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "expiresAt", "id", "lastUsedAt", "name", "revoked", "scope"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatResponse from a dict"""
        if obj is None:
            return None
