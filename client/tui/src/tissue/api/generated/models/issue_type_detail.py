...
class IssueTypeDetail(BaseModel):
    """
    IssueTypeDetail
    """ # noqa: E501
    color: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    fields: Optional[List[IssueFieldDetail]] = None
    hierarchy: Optional[StrictStr] = Field(default=None, description="4-level issue hierarchy (top to bottom): EPIC (highest), STANDARD (child of a EPIC), SUBTASK (child of a STANDARD), MICROTASK (child of a SUBTASK). A parent must be exactly one level above its child.See [Issue Hierarchy](#tag/Issue Hierarchy) for details.")
    icon: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    system_provided: Optional[StrictBool] = Field(default=None, alias="systemProvided")
    ...
    __properties: ClassVar[List[str]] = ["color", "description", "fields", "hierarchy", "icon", "id", "name", "systemProvided", "workflowId", "workflowName"]
    ...
    def hierarchy_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueTypeDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueTypeDetail from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fields": [IssueFieldDetail.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "hierarchy": obj.get("hierarchy"),
            "icon": obj.get("icon"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "systemProvided": obj.get("systemProvided"),
