...
class WorkspaceMemberSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "joinedAt", "memberId", "role", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceMemberSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceMemberSummary from a dict"""
        if obj is None:
            return None
