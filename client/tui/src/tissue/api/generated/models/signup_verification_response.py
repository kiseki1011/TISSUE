...
class SignupVerificationResponse(BaseModel):
    ...
    """ # noqa: E501
    verification_id: Optional[StrictStr] = Field(default=None, description="Verification ID for polling verification status", alias="verificationId")
    __properties: ClassVar[List[str]] = ["verificationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignupVerificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignupVerificationResponse from a dict"""
        if obj is None:
            return None
