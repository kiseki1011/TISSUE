...
class PageWikiTagDetail(BaseModel):
    """
    PageWikiTagDetail
    """ # noqa: E501
    content: Optional[List[WikiTagDetail]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageWikiTagDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageWikiTagDetail from a dict"""
        if obj is None:
            return None
