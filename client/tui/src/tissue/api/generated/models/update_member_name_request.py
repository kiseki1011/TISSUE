...
class UpdateMemberNameRequest(BaseModel):
    ...
    """ # noqa: E501
    new_name: Annotated[str, Field(min_length=2, strict=True, max_length=35)] = Field(alias="newName")
    __properties: ClassVar[List[str]] = ["newName"]

    @field_validator('new_name')
    def new_name_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateMemberNameRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateMemberNameRequest from a dict"""
        if obj is None:
            return None
