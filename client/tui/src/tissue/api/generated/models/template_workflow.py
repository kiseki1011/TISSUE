...
class TemplateWorkflow(BaseModel):
    ...
    initial_state_name: Optional[StrictStr] = Field(default=None, alias="initialStateName")
    name: Optional[StrictStr] = None
    states: Optional[List[TemplateState]] = None
    temp_id: Optional[StrictStr] = Field(default=None, alias="tempId")
    transitions: Optional[List[TemplateTransition]] = None
    __properties: ClassVar[List[str]] = ["color", "description", "initialStateName", "name", "states", "tempId", "transitions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateWorkflow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateWorkflow from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "initialStateName": obj.get("initialStateName"),
            "name": obj.get("name"),
            "states": [TemplateState.from_dict(_item) for _item in obj["states"]] if obj.get("states") is not None else None,
            "tempId": obj.get("tempId"),
            "transitions": [TemplateTransition.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None
        })
        return _obj
