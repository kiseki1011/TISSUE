...
class BatchChangeParentRequest(BaseModel):
    """
    BatchChangeParentRequest
    """ # noqa: E501
    issue_keys: Annotated[List[StrictStr], Field(min_length=0, max_length=100)] = Field(alias="issueKeys")
    parent_issue_key: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="parentIssueKey")
    __properties: ClassVar[List[str]] = ["issueKeys", "parentIssueKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchChangeParentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchChangeParentRequest from a dict"""
        if obj is None:
            return None
