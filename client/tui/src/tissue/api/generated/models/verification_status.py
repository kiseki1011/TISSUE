...
class VerificationStatus(BaseModel):
    ...
    verified_token: Optional[StrictStr] = Field(default=None, alias="verifiedToken")
    __properties: ClassVar[List[str]] = ["status", "verifiedToken"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['PENDING', 'VERIFIED', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('PENDING', 'VERIFIED', 'UNKNOWN')")
        return value
