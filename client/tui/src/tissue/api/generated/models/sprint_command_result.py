...
class SprintCommandResult(BaseModel):
    """
    SprintCommandResult
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["projectKey", "sprintId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SprintCommandResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SprintCommandResult from a dict"""
        if obj is None:
            return None
