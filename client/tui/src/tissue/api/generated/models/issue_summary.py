...
class IssueSummary(BaseModel):
    ...
    current_state_label: Optional[StrictStr] = Field(default=None, alias="currentStateLabel")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "currentStateLabel": obj.get("currentStateLabel"),
            "dueAt": obj.get("dueAt"),
            "id": obj.get("id"),
