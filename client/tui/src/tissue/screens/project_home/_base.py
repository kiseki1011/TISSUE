...
class ProjectHomeBase(RefreshableScreen):
    ...
    def _title_extra(self) -> int:
        """Extra Title width when [2]/[3] are collapsed and [1] fills the row."""
        from tissue.screens.project_home.rendering import _EXPANDED_TITLE_EXTRA

        return _EXPANDED_TITLE_EXTRA if self._ui.expanded else 0
