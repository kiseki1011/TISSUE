...
import static com.tissue.security.authentication.domain.exception.AuthenticationErrorCode.*;
...
public final class MemberExceptions {
    ...
    public static ResourceNotFoundException notFound(Long memberId) {
        return new ResourceNotFoundException(MEMBER_NOT_FOUND).addContext(MEMBER_ID, memberId);
    }

    public static ResourceConflictException duplicateEmail(String email) {
        return new ResourceConflictException(DUPLICATE_EMAIL).addContext(EMAIL, email);
    }

    public static ResourceConflictException duplicateEmail(String email, Throwable e) {
        return new ResourceConflictException(DUPLICATE_EMAIL, e).addContext(EMAIL, email);
    }

    public static ResourceConflictException duplicateUsername(String username) {
        return new ResourceConflictException(DUPLICATE_USERNAME).addContext(USERNAME, username);
    }
    ...
    public static ResourceConflictException verificationTokenDuplicate(String email) {
        return new ResourceConflictException(VERIFICATION_TOKEN_DUPLICATE).addContext(EMAIL, email);
    }
    ...
    public static ForbiddenException emailNotVerified(String email) {
        return new ForbiddenException(EMAIL_NOT_VERIFIED).addContext(EMAIL, email);
    }
}
