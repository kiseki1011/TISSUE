...
public class ProjectExceptions {
    ...
    public static ResourceNotFoundException notFound(Long projectId) {
        return new ResourceNotFoundException(PROJECT_NOT_FOUND).addContext(PROJECT_ID, projectId);
    }
    ...
    public static BadRequestException reservedKey(String projectKey) {
        return new BadRequestException(RESERVED_PROJECT_KEY).addContext(PROJECT_KEY, projectKey);
    }
