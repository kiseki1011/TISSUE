package com.tissue.authentication.adapter.web;

import com.tissue.authentication.adapter.web.request.LoginRequest;
import com.tissue.authentication.adapter.web.request.RefreshTokenRequest;
...
import com.tissue.member.adapter.web.request.PermissionRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest request) {
        LoginResponse response = authenticationUseCase.login(request.loginEmail(),
            request.password());
