...
public interface WorkspaceSecurityExpressions {
	...
	// String REQUIRES_MEMBER = "@workspaceSecurityGuard.isHigherThanMember(#cmd.workspaceKey(), principal.memberId)";
	String REQUIRES_ADMIN = "@workspaceSecurityGuard.isHigherThanAdmin(#cmd.workspaceKey(), principal.memberId)";
