...
public class IssueSecurityGuard {
	 ...
	 * <ul>
	 *   <li>The member is a project administrator ({@link com.tissue.api.project.domain.enums.ProjectRole#ADMIN ProjectRole.ADMIN})</li>
	 *   <li>The member has workspace administrator privileges or higher
	 *       ({@link com.tissue.api.workspace.domain.enums.WorkspaceRole#ADMIN WorkspaceRole.ADMIN} or above)</li>
