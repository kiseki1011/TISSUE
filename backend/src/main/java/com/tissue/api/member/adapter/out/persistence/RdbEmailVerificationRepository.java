package com.tissue.api.member.adapter.out.persistence;
...
import com.tissue.api.member.application.port.out.EmailVerificationJpaRepository;
import com.tissue.api.member.application.port.out.EmailVerificationRepository;
import com.tissue.api.member.domain.EmailVerificationToken;
