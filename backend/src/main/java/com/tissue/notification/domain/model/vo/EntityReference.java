package com.tissue.notification.domain.model.vo;
...
public class EntityReference {
    ...
    public static EntityReference forReview(String workspaceCode, String issueKey, Long reviewId) {
        return EntityReference.builder()
                .workspaceCode(workspaceCode)
    ...
    public static EntityReference forReviewComment(
            String workspaceCode, String issueKey, Long reviewId, Long commentId) {
        return EntityReference.builder()
                .workspaceCode(workspaceCode)
