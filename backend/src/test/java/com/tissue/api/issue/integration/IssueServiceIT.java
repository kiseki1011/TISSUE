...
class IssueServiceIT extends ServiceIntegrationTestHelper {
	...
	// 	// when & then
	// 	assertThatThrownBy(
	// 		() -> issueService.updateIssue(workspace.getCode(), issue.getIssueKey(), workspaceMember1.getId(),
	// 			request))
	...
	// 	issueService.assignParentIssue(
	// 		workspace.getCode(),
	...
	//
	// 	// when & then
	// 	assertThatThrownBy(() -> issueService.removeParentIssue(
	// 		workspace.getCode(),
	// 		childIssue.getIssueKey(),
	// 		workspaceMember1.getId()
	// 	)).isInstanceOf(InvalidOperationException.class);
