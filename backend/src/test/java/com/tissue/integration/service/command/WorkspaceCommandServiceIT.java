...
class WorkspaceCommandServiceIT extends ServiceIntegrationTestHelper {
	...
	//
	// 	// then
	// 	assertThat(workspaceRepository.findByKey(workspace.getKey())).isEmpty();
	// }
	//
	// @Test
	// @Transactional
	...
	//
	// 	// then
	// 	assertThat(workspaceRepository.findByKey(workspace.getKey()).get().getName())
	// 		.isEqualTo("updated workspace name");
	//
	// 	assertThat(workspaceRepository.findByKey(workspace.getKey()).get().getDescription())
	...
	//
	// 	// then
	// 	String updatedPassword = workspaceRepository.findByKey(workspace.getKey()).get().getPassword();
	//
