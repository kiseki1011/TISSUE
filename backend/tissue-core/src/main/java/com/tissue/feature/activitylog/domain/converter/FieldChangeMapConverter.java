package com.tissue.feature.activitylog.domain.converter;
 ...
 *
 * <p>This converter maps a {@code Map<String, FieldChange>} structure to a database TEXT column.
 * It
 * is primarily used in {@code ActivityLog} to persist details about what fields were modified
 * during an event (e.g., issue updates).
 *
