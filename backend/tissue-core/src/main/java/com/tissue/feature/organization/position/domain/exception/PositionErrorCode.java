...
public enum PositionErrorCode implements ErrorCode {
    ...
    DUPLICATE_POSITION_NAME(HttpStatus.CONFLICT, "Position name must be unique for workspace"),
    POSITION_IN_USE(HttpStatus.CONFLICT, "Postion is in use by a workspace member");
