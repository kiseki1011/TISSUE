package com.tissue.feature.workflow.adapter.web;

import com.tissue.feature.member.domain.exception.MemberErrorCode;
import com.tissue.feature.workflow.adapter.web.request.ConfigureTransitionGuardsRequest;
import com.tissue.feature.workflow.adapter.web.request.CreateWorkflowRequest;
import com.tissue.feature.workflow.adapter.web.request.ReplaceWorkflowGraphRequest;
import com.tissue.feature.workflow.adapter.web.request.UpdateStateRequest;
import com.tissue.feature.workflow.adapter.web.request.UpdateTransitionRequest;
import com.tissue.feature.workflow.adapter.web.request.UpdateWorkflowRequest;
import com.tissue.feature.workflow.adapter.web.request.UpdateWorkflowVcsSettingsRequest;
...
public class WorkflowCommandController {
    ...
    public ResponseEntity<WorkflowCreateResponse> createWorkflow(
        ...
        WorkflowCreateResponse response = workflowCommandUseCase.create(command, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> replaceWorkflowGraph(
        ...
        var command = request.toCommand();
        workflowGraphReplaceUseCase.replaceWorkflowGraph(workflowId, command, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> updateWorkflow(
            ...
            @CurrentMember MemberDetails memberDetails) {
        var command = request.toCommand();
        workflowCommandUseCase.update(workflowId, command, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> updateWorkflowVcsSettings(
            ...
            @CurrentMember MemberDetails memberDetails) {
        workflowCommandUseCase.updateVcsSettings(workflowId, request.toCommand(), memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> deleteWorkflow(
        ...
        workflowCommandUseCase.delete(workflowId, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> updateWorkflowState(
            ...
            @CurrentMember MemberDetails memberDetails) {
        var command = request.toCommand();
        workflowCommandUseCase.updateState(workflowId, stateId, command, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> updateWorkflowTransition(
            ...
            @CurrentMember MemberDetails memberDetails) {
        var command = request.toCommand();
        workflowCommandUseCase.updateTransition(workflowId, transitionId, command, memberDetails.getMemberId());
    ...
    public ResponseEntity<Void> configureTransitionGuards(
        ...
        workflowCommandUseCase.configureTransitionGuards(
                workflowId, transitionId, request.toCommand(), memberDetails.getMemberId());
