...
import com.tissue.feature.workspace.application.service.InvitationCommandService;
...
@Transactional
class InvitationCommandServiceIntegrationTest extends IntegrationTestSupport {
    ...
    class AcceptInvitation {
        ...
        void acceptCreatesWorkspaceMember() {
            ...
            // when
            invitationCommandService.accept(invitee.getId(), invitationId);
            em.flush();
            em.clear();
        ...
        void acceptWithProjectKeysJoinsProjects() {
            ...
            // when
            invitationCommandService.accept(invitee.getId(), invitation.getId());
            em.flush();
            em.clear();
    ...
    class RejectInvitation {
        ...
        void rejectDeletesInvitation() {
            ...
            // when
            invitationCommandService.reject(invitee.getId(), invitationId);
            em.flush();
            em.clear();
