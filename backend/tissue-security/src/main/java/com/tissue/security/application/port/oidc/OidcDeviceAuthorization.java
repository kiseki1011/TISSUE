...
/**
 * The IdP's response to a device authorization request (RFC 8628 §3.2).
 *
 ...
 * @param verificationUriComplete optional URI embedding the user code (for QR/clickthrough)
